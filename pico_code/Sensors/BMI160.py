# -*- coding:utf-8 -*-
# Modified from https://github.com/DFRobot/DFRobot_BMI160/blob/6abe9dc9ed817a806c1a143ff6adc92a2c4e9985/python/raspberrypi/DFRobot_BMI160.py to support MicroPython I2C communication on the Pi Pico, fix several bugs, and add FIFO support.
...
#     return val
  ...
  def _get_raw_data(self):
    ...
    if rslt[0] == BMI160_OK:
      #lsb = rslt[index]
      #msb = rslt[index+1]
      #self._gyro_x = int16((msb)*256 + lsb)
      #index += 2
      
      #lsb = rslt[index]
      #msb = rslt[index+1]
      #self._gyro_y = (msb)*256 + lsb
      #index += 2
      
      #lsb = rslt[index]
      #msb = rslt[index+1]
      #self._gyro_z = (msb)*256 + lsb
      #index += 2
      
      #lsb = rslt[index]
      #msb = rslt[index+1]
      #self._accel_x = (msb)*256 + lsb
      #index += 2
      
      #lsb = rslt[index]
      #msb = rslt[index+1]
      #self._accel_y = (msb)*256 + lsb
      #index += 2
      
      #lsb = rslt[index]
      #msb = rslt[index+1]
      #self._accel_z = (msb)*256 + lsb
      #index += 2
...
class BMI160_I2C(DFRobot_BMI160):
  ...
  # For header mode parsing, see bmi160_fifo_test.py
